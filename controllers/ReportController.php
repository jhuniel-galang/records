...
class ReportController extends BaseController {
    ...
    public function index() {
        ...
        $top_schools = $document->getTopSchoolsByDocumentCount(10, $filters);
        
        // Get schools by document count (all schools)
        $schools_by_document_count = $document->getSchoolsByDocumentCount();
        ...
        // Use renderPrint instead of render to avoid sidebar
        $this->renderPrint('report/index.php', $data);
    }
    
    // Export report as PDF (using HTML/CSS print)
    public function exportPDF() {
        ...
        // Use renderPrint instead of render to avoid sidebar
        $this->renderPrint('report/export.php', $data);
    }
}
?>